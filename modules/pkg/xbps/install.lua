...
return {
	name = "xbps install",
	description = "Install one or more Void packages with xbps-install when missing.",
	requires = { all = { { command = "xbps-install" }, { command = "xbps-query" } } },
	...
	apply = function(ctx, args)
		...
		return command_result("updated", command_detail("xbps-install", argv), "installed packages", missing, "install")
	end,
}
