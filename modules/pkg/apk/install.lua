...
return {
	name = "apk install",
	description = "Install one or more Alpine packages with apk when missing.",
	...
	apply = function(ctx, args)
		...
		return command_result("updated", command_detail("apk", argv), "installed packages", missing, "install")
	end,
}
