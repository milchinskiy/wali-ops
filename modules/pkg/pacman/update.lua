...
return {
	name = "pacman update",
	description = "Refresh Arch package databases with pacman -Sy.",
	...
	apply = function(ctx, args)
		local argv = { "-Sy", "--noconfirm" }
		checked(ctx, "pacman", argv, args.timeout)
		return command_result("updated", command_detail("pacman", argv), "updated package indexes", {}, "update")
	end,
}
